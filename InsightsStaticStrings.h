...
static constexpr const char kwRequires[] = KW_REQUIRES;
//-----------------------------------------------------------------------------
...
static constexpr const char kwConstEvalSpace[] = BUILD_WITH_SPACE_AFTER(KW_CONSTEVAL);
static constexpr const char kwConstInitSpace[] = BUILD_WITH_SPACE_AFTER(KW_CONSTINIT);
...
static constexpr const char kwRequiresSpace[] = BUILD_WITH_SPACE_AFTER(KW_REQUIRES);
//-----------------------------------------------------------------------------
